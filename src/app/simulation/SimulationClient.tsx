...
/**
 * SimulationClient - Client Component
 * Handles the state, map animation loop, and interactive controls for the disaster simulation.
 */
export function SimulationClient() {
  ...
  // Neural Settings Link: Synchronize simulation velocity with global settings
  useEffect(() => {
  ...
  // Generates dynamic vector data for the map overlay based on temporal progress and intensity
  ...
  const currentConfig = disasterConfig[disasterType]
  const CurrentDisasterIcon = currentConfig.icon
        ...
        <Card className="glass-card backdrop-blur-3xl border-t-2 border-t-white/10">
          <CardContent className="p-4 space-y-3">
             <div className="flex items-center justify-between text-[10px] font-bold uppercase">
                ...
                <span className="text-primary">{currentConfig.label}</span>
             </div>
